              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '2px solid var(--color-teal)', textAlign: 'left' }}>
                    ...
                    <th style={{ padding: '12px', width: '18%' }}>Email</th>
                    <th style={{ padding: '12px', width: '18%' }}>Subject</th>
                    <th style={{ padding: '12px', width: '28%' }}>Message</th>
                    <th style={{ padding: '12px', width: '8%' }}>Date</th>
                    <th style={{ padding: '12px', width: '8%' }}>Action</th>
                  </tr>
                </thead>
                <tbody>
