    ...
    <>
      ...
      <section className="content-padding">
        <div className="container bg-surface" style={{ padding: '50px', borderRadius: '12px' }}>
          ...
          <p className="mb-4">Your personal data is strictly used for the following purposes:</p>
          <ul className="action-points mb-4">
          ...
          <p className="mb-4">We do not sell, rent, or trade your personal information. Your data is only shared with:</p>
          <ul className="action-points mb-4">
