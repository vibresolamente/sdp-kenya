                ...
                <div className="contact-info">
                    ...
                    <table className="official-contact-table">
                        <tbody>
                            ...
                            <tr><td><strong>Mailing Address:</strong></td><td>P.O. Box 1559-50100 Kakamega</td></tr>
                        </tbody>
                    </table>

                    <h3 className="mt-5">Follow Our Official Handles</h3>
                    <div className="social-links" style={{ fontSize: '1rem', display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '12px' }}>
                        <a href="https://facebook.com/SDPKenya" target="_blank" rel="noopener noreferrer">📘 Facebook (SDPKenya)</a>
                        <a href="https://x.com/SDPKenya" target="_blank" rel="noopener noreferrer">𝕏 / Twitter (@SDPKenya)</a>
                        <a href="https://instagram.com/SDPKenya" target="_blank" rel="noopener noreferrer">📸 Instagram (SDPKenya)</a>
                        <a href="https://linkedin.com/company/SDPKenya" target="_blank" rel="noopener noreferrer">💼 LinkedIn (SDPKenya)</a>
                        <a href="https://tiktok.com/@SDPKenya" target="_blank" rel="noopener noreferrer">🎵 TikTok (@SDPKenya)</a>
                    </div>

                    <div className="mt-5">
                        <a href="https://orpp.or.ke/" target="_blank" rel="noopener noreferrer" className="cta-button" style={{ background: '#ffffff', color: '#d8006f', fontWeight: 'bold', fontSize: '0.9rem' }}>
                            🏛️ Visit ORPP Official Portal (https://orpp.or.ke/)
                        </a>
                    </div>
                </div>
