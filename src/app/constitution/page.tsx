    ...
    <section className="content-padding">
        <div className="container">
            <div className="manifesto-header text-center">
                <h1>SDP Kenya <span className="animated-accent">Constitution</span></h1>
            ...
            <div className="manifesto-details bg-surface" style={{ borderRadius: '8px' }}>
                <div className="pillar-detail-block" style={{ borderBottom: 'none', marginBottom: 0, paddingBottom: 0 }}>
                    ...
                    <h2 className="mt-5">Table of Contents (Preview)</h2>
                    <ul className="action-points">
                        <li>Preamble and Name of the Party</li>
                        <li>Aims, Objectives, and Ideology</li>
                        <li>Membership and Rights</li>
                        <li>Party Structure and Organs</li>
                        <li>Financial Provisions</li>
                        <li>Disciplinary Procedures and Dispute Resolution</li>
                    </ul>
                </div>
            </div>
        </div>
